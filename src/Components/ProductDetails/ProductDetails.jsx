      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col items-center">
          ...
          <Slider
            ref={detailsRef}
            {...settings}
            className="details_slider w-full sm:w-[80%] mt-4"
          >
            {productDetails?.images?.map((el, index) => (
              <div key={index} onClick={() => imageHandler(el, index)}>
                <img className="h-24 sm:h-32 w-full object-contain" src={el} alt="" />
              </div>
            ))}
          </Slider>
        </div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              {productDetails?.quantity > 0 && (
                <div className="flex h-10">
                  ...
                  <div className="border border-gray-300 px-4 flex items-center">{count}</div>
                  <button
                    disabled={count === 5}
                    onClick={increase}
                    className={`border border-gray-300 px-3 ${
        ...
        {tabActive === 1 && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              {/* Add Review */}
              <h2 className="text-lg sm:text-2xl mt-6 mb-2">Add a Review</h2>
              <form>
                <textarea
