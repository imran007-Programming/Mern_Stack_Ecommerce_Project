  ...
  return (
    <div className='container mx-auto sm:px-10 px-3'>
        <div className="map my-5 ">
          <h2 className="text-2xl my-3">Our Location</h2>
        ...
        <form action="">
        <div className="my-20 form grid grid-cols-1 md:grid-cols-2 gap-7">
            <div className="form-text">
              <h5 className='text-2xl my-3'>Contact US</h5>
              ...
              <h1 className='text-[black] text-2xl font-[500]'>Usa</h1>
              <p className='py-2 text-[black] text-[15px] font-[500]' >195E parker square Dr,Parker Co 801 <br />
              +343543030521
              </p>
              <h2 className='text-[black] text-2xl font-[500] my-1' >Bangladesh</h2>
              <p className='text-[black] text-2xl font-[500]' >gulshan Avenue.Street No.52.park avenue</p>
              +88023242353255
            </div>
